...
initContentMore({
  ...
  data: [...venuesCards].filter((item) => item.category === 'bigVenues'),
  showCount: 4,
  showCountMobile: 2,
...
initContentMore({
    containerSelector: ".moreContent__items.moreContent__items--fiftyPerson",
    data: [...venuesCards].filter((item) => item.category === 'fiftyPerson'),
    showCount: 4,
    showCountMobile: 2,
    maxWidthInitMobile: 650,
    buttonTexts: {
